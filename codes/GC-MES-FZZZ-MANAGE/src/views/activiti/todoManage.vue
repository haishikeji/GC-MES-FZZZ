...
export default {
  ...
  mounted() {
    console.log("mounted Method begin")
    this.init();
  },
  methods: {
    init() {
    ...
    loadData(){},
    getDataList() {
      console.log("getDataList Method begin")
      this.loading = true;
      postFormAction('/actTask/todoList',this.searchForm).then(res => {
        this.loading = false;
        console.log(res)
        if (res.success) {
      ...
      console.log("getDataList Method end")
    },
